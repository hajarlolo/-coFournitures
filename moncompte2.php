        ...
        <section class="profil-section">
            <div class="infos-card">
                ...
                <div class="profile-pic-container">
                    <img src="<?php echo $utilisateur['photo_profil'] ? 'uploads/' .  $utilisateur['photo_profil']: 'default_avatar.jpeg'; ?>" alt="Photo de profil" class="profile-pic">
                </div>
            </div>
                                ...
                                <div>
                                    ...
                                    <div style="margin-top: 10px;">
                                        <a href="modifierpost.php?id=<?php echo $produit['id']; ?>" class="btn-ajout"
                                            style="background-color:rgba(255, 255, 255, 0);">Modifier</a>
